...
//
// Copyright of The $BorneoProject Team
// There is a pot of gold at the end of every Borneo
// 
// $Borneo has 3% tax split across 7 protocols
// #1BOCH = #1GRAM OF CARBONCREDIT
...
contract BorneoProject is Context, IERC20, Ownable {
    ...
    // General Info
    string private _name     = "BorneoCarbon";
    string private _symbol   = "BOCH";
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x3667fdfdE3e54Fb674e68d61c799Bf13aa529124); // Marketing address used to pay for marketing
    ...
    uint256 private _tTotal = 21 * 10**12 * 10**6;
    ...
    // Token Limits
    uint256 public _maxTxAmount        = 21 * 10**12 * 10**6; // ===========
    uint256 public _tokenSwapThreshold = 10 * 10**12 * 10**6; // ===========
    
    // Timer Constants 
    uint private constant DAY = 60 * 60 * 24; // How many seconds in a day
    
    // Anti-Whale Settings 
    uint256 public _whaleSellThreshold = 5 * 10**9 * 10**6; // ============
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**6; // 1 billion $Borneo will be used to buy at maximum in any one trade
